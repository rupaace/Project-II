...
class EmployeeProfileUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['former_job'].widget.attrs.update(
            {
                'placeholder': 'Previously Worked On',
            }
        )
        self.fields['experience'].widget.attrs.update(
            {
                'placeholder': 'Your Working Experience',
            }
        )
    ...
    class Meta:
        model = User
        fields = ["first_name", "last_name", "gender","phone_number","education","skills","former_job","eligibility","experience","bio","website","image"]
